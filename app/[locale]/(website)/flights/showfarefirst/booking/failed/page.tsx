...
export default function Page() {
  ...
  useEffect(() => {
    try {
      ...
      console.error("Error loading booking failed data:", error);
    }
  }, []);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 relative z-10">
            <div className="lg:col-span-2 space-y-2.5">
              <Payment
                ...
                failureReason="The payment did not complete on gateway. Please retry with another card."
              />
              <FlightDetails
            ...
            <aside className="lg:col-span-1 lg:self-start lg:sticky lg:top-6 lg:z-20">
              <section className="rounded bg-white p-6">
                <div className="flex items-center justify-between border-b border-dashed border-gray-300 pb-5">
                  <h3 className="text-22 font-bold leading-none ">Total Amount</h3>
                ...
                <div className="space-y-2 pt-5">
                  <div className="flex items-center justify-between">
                    <h4 className="text-20 font-bold leading-none ">Booking total</h4>
                  ...
                  <p className="text-12 font-normal leading-snug text-red-500">
                    Please note that the payment method cannot be changed once the transaction has
                    been completed
                  </p>
