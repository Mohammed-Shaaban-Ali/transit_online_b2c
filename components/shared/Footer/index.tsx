...
function Footer() {
  ...
  return (
    <footer className="bg-[#066e9b]">
      ...
      <section className="pt-6 pb-10 container  ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-10 mt-2">
          ...
          <div className="col-span-1 flex flex-col gap-7">
            <div className="flex items-center gap-1.5">
              ...
              <p className="text-15 text-white/70 ">{t("location")}</p>
            </div>
            <div className="flex items-center gap-1.5">
            ...
            <div className=" flex sm:flex-col flex-row gap-7 w-fit  sm:ms-0">
              {links?.map((i) => (
                <Link
                  href={i.href}
                  key={i.label}
                  className="text-15  text-white/70 hover:text-white transition-all duration-300"
                >
                  {i.label}
                </Link>
              ))}
