...
function Trip({}: Props) {
  ...
  const t = useTranslations("NewPage.home.trip");
            ...
            <SwiperSlide key={index} className="min-w-0 max-w-full h-full">
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-t-lg h-[110px] ">
                  ...
                  <span className="text-white text-[20px] font-bold absolute bottom-0 start-1 end-0 p-2">
                    {hotel.alt}
                  </span>
                  <div className="absolute top-3 start-2  p-1 bg-white/70 w-fit py-0.5 text-[10px] rounded">
                    {t("badge")}
                  </div>
                </div>
              </article>
