...
export const FeaturedDestinationCard = ({
  ...
  const imageUrl = `https://gita.sa/storage/${post.featured_image}`;
  return (
    <div className=" bg-white rounded-xl border border-gray-300 p-2.5 h-full flex flex-col justify-between">
      <Link
...
export const FeaturedDestinationCardSkeleton = () => {
  return (
    <div className="rounded-xl border border-gray-300 p-2 animate-pulse">
