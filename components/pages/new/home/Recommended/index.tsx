...
function Recommended({}: Props) {
  ...
  const recommendedTabs = [
    {
      ...
      links: [
        t("link_flightsBangkok"),
        t("link_flightsManila"),
        t("link_flightsShanghai"),
        t("link_flightsTokyo"),
        t("link_flightsSeoul"),
        t("link_flightsKL"),
        t("link_flightsPhnomPenh"),
        t("link_flightsHK"),
        t("link_flightsGuangzhou"),
    ...
    },
    {
      ...
      links: [
        ...
        t("link_dubaiLondon"),
        t("link_jeddahCairo"),
        t("link_riyadhIstanbul"),
        t("link_abuDhabiBangkok"),
        t("link_dohaManila"),
        t("link_kuwaitAmman"),
        t("link_riyadhDubai"),
        t("link_dammamCairo"),
    ...
    },
    {
      ...
      links: [
        ...
        t("link_flightsUAE"),
        t("link_flightsEgypt"),
        t("link_flightsTurkey"),
        t("link_flightsThailand"),
        t("link_flightsPhilippines"),
        t("link_flightsIndia"),
        t("link_flightsMalaysia"),
        t("link_flightsUK"),
        t("link_flightsItaly"),
      ],
    },
  ...
  return (
    <section className="container max-w-[1200px]! mx-auto py-7">
      <h2 className="mb-6 text-[22px] font-bold leading-tight ">
        {t("title")}
      </h2>
