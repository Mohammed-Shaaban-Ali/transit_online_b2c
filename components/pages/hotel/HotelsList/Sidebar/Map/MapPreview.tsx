  ...
  return (
    ...
    >
      <div className="map-marker-container">
        {isSmall ? (
          <div className="small-marker">
            <div className="small-marker-dot"></div>
          </div>
        ) : (
          <>
...
export default function MapPreview({
  ...
  useEffect(() => {
    ...
    } else if (map && center && validateCoords(center.lat, center.lng)) {
  ...
  if (!isLoaded) {
    return (
      ...
      >
        <div
          className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#0E8571]"
          role="status"
        >
